...
const Hero =()=> {
  ...
  return(
    <section className="relative md:flex md:items-center  bg-[url('../public/imgs/sanFrancisco.jpg')] md:bg-[url('../public/imgs/sanFranciscoDesktop.jpg')] bg-cover h-screen md:h-[90vh]">
